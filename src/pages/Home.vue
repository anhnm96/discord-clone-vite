    ...
    <header class="flex justify-between py-8">
      ...
      <div class="flex gap-4">
        <template v-if="!userStore.isAuth">
          <router-link
            to="/login"
            class="px-4 py-2 transition border rounded-md hover:bg-purple bg-primary text-primary border-primary"
          >
            Login
          </router-link>
          <router-link
    ...
    <main class="flex items-center flex-grow">
      <div class="flex flex-col-reverse justify-between gap-10 md:gap-5 md:flex-row">
        <div class="flex flex-col items-start justify-center w-4/5 mx-auto space-y-6 md:w-2/5">
          <h1 class="text-3xl font-semibold text-center lg:text-4xl md:text-left text-primary">
          ...
          <router-link
            to="/register"
            class="px-4 py-2 mx-auto font-medium text-gray-900 transition rounded-md md:mx-0 hover:bg-blue-dark bg-blue-light"
          >
            Get Started
          </router-link>
        ...
        <div class="flex items-center justify-center w-4/5 mx-auto sm:w-3/5 md:w-1/2 lg:w-3/5">
          <img
